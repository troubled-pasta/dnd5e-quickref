data_freeaction = [
    {
        ...
        bullets: [
            ...
            "<b>Knock Down</b> <i>(Melee Only)</i><b>:</b> This attack deals no damage but if successful amd the attacker’s STR + Net Hits exceeds the defender's Physical limit, the attacker knocks the defender to the ground. The attacker may choose to follow (Drop Prone) for free. On a critical glitch, the attacker falls down while the defender stays standing.",
