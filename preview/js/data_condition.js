data_condition = [
    ...
    },
    {
        ...
        bullets: [
            "<table><thead><tr><th>Condition</th><th>Dice Pool Modifier</th><th>Compensation</th><th>Effect</th></tr></thead><tbody><tr><td>Visibility</td><td>Clear (0)<br>Light (-1)<br>Moderate (-3)<br>Heavy Obstruction (-6)</td><td>Ultrasound<br>Thermographic Vision</td><td>Shift up 1 step<br>Shift up 1 step<br></td></tr><tr><td>Light</td><td>Full Light (0)<br>Partial (-1)<br>Dim (-3)<br>Total Darkness (-6)</td><td>Low-Light Vision<br>Thermographic Vision<br>Ultrasound<br>Sunglasses</td><td>Partial and Dim light become Full Light<br>Shift up 1 step<br>Ignore Light conditions within 50m<br>Shift down 1 step</td></tr><tr><td>Glare</td><td>None (0)<br>Weak (-1)<br>Moderate (-3)<br>Blinding (-6)</td><td>Sunglasses<br>Flare Compensation</td><td>Shift up 1 step<br>Shift up 2 steps<br></td></tr><tr><td>Range</td><td>Short (0)<br>Medium (-1)<br>Long (-3)<br>Extreme (-6)</td><td>Image Magnification</td><td>Shift up 1 step</td></tr></tbody></table>",
