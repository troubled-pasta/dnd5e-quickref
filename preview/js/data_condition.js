data_condition = [
    ...
    },
    {
        ...
        bullets: [
            "<table><thead><tr><th>Condition</th><th>Dice Pool Modifier</th><th>Compensation</th><th>Effect</th></tr></thead><tbody><tr><td>Visibility</td><td>Clear (0), Light (-1),<br>Moderate (-3), Heavy Obstruction (-6)</td><td>Ultrasound<br>Thermographic Vision</td><td>Reduce modifier by one step<br>Reduce modifier by one step<br></td></tr><tr><td>Light</td><td>Full Light (0), Partial (-1),<br>Dim (-3), Total Darkness (-6)</td><td>Low-Light Vision<br>Thermographic Vision<br>Ultrasound</td><td>Partial and Dim light become Full Light<br>Reduce modifier by one step<br>Ignore Light conditions within 50m</td></tr><tr><td>Glare</td><td>None (0), Weak (-1),<br>Moderate (-3), Blinding (-6)</td><td>Sunglasses<br>Flare Compensation</td><td>Reduce modifier by one step (increase Light modifier by one)<br>Reduce modifier by two steps<br></td></tr><tr><td>Range</td><td>Short (0), Medium (-1),<br>Long (-3), Extreme (-6)</td><td>Image Magnification</td><td>Reduce Modifier by one step</td></tr></tbody></table>",
